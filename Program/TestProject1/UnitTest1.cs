...
namespace TestProject1
{
    public class UnitTest1
    {
        ...
        public void TestAverage()
        {
            ...
            Assert.Equal(2, Program.Program.Avg(arr3));
        }
        // test challenge 4 
        [Fact]
        public void TestMostFrequent()
        {
            ...
            Assert.Equal(0, Program.Program.mostFrequent(arr));
        ...
        {
            string[] arr = { "Good:4,", "Morning:7," };
            string[] arr2 = { "Good:4,", "Morning:7,", "!!!:3," };
            Assert.Equal(arr, Program.Program.WordsCount("Good Morning"));
            Assert.Equal(arr2, Program.Program.WordsCount("Good Morning !!!"));
        }
    }
}
